...
class _FakeGoogleSignInAuthentication_21 extends _i1.SmartFake
    implements _i8.GoogleSignInAuthentication {
  _FakeGoogleSignInAuthentication_21(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
  ...
  _i7.Future<_i6.QuerySnapshot<T>> namedQueryWithConverterGet<T>(
    ...
    required _i6.ToFirestore<T>? toFirestore,
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i7.Future<_i6.QuerySnapshot<T>>.value(_FakeQuerySnapshot_13<T>(
          this,
          Invocation.method(
            #namedQueryWithConverterGet,
            [name],
...
class MockWriteBatch extends _i1.Mock implements _i6.WriteBatch {
  ...
  @override
  _i7.Future<void> commit() => (super.noSuchMethod(
        Invocation.method(
          #commit,
          [],
        ),
