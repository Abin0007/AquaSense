...
class AuthService {
  ...
  Future<User?> loginUser({
    ...
    try {
      ...
      // ** THE FIX IS HERE **
      // Force a reload of the user's profile to get the latest status from Firebase.
      await user?.reload();
      // Get the refreshed user object after reloading.
      final refreshedUser = _auth.currentUser;

      // Now, check the emailVerified status on the *refreshed* user object.
